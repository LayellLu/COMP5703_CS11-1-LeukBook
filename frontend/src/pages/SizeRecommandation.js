                ...
                <Col md={6}>
                    <ListGroup variant="flush">
                        ...
                        <Row>
                            ...
                            <div>
                                ...
                                <Col md={13}>
                                    <Button
                                        className="btn-block"
                                        type="button" style={{ color: 'black', backgroundColor: 'white' }}>
                                        8
                                    </Button>
                                    <Button
                                        className="btn-block"
                        ...
                        <Card>
                            <Button
                                className="btn-block"
                                type="button" style={{ color: 'red', backgroundColor: 'pink' }} >
                        ...
                        <Card>
                            <Button
                                className="btn-block"
                                type="button" style={{ color: 'white', backgroundColor: 'orange' }} >
                                Add to wish list
                            </Button>
                        </Card>
